...
public class BootProj11LayeredAppRealtimeDiProfileMultilpleYmlFileApplication {
	...
	public static void main(String[] args) {
		...
		ApplicationContext ctx = SpringApplication
				.run(BootProj11LayeredAppRealtimeDiProfileMultilpleYmlFileApplication.class, args);
