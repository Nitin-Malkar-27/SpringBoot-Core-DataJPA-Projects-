...
public class BootProj12LayeredAppProfilesSingleYmlFileApplication {
	...
	public static void main(String[] args) {
		...
		// get IOC container
		ApplicationContext ctx = SpringApplication.run(BootProj12LayeredAppProfilesSingleYmlFileApplication.class,
				args);
